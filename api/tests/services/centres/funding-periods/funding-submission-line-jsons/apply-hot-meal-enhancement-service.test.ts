...
import ApplyHotMealEnhancementService from "@/services/centres/funding-periods/funding-submission-line-jsons/apply-hot-meal-enhancement-service"

describe("api/src/services/centres/funding-periods/funding-submission-line-jsons/apply-hot-meal-enhancement-service.ts", () => {
  describe("ApplyHotMealEnhancementService", () => {
    describe("#perform", () => {
      beforeEach(() => {
        vi.useFakeTimers()
      })
      ...
      test("when provided with a centre with hot meal enabled, and Quality Enhancement Program sections exist in a future funding submission line json, applies enhancement", async () => {
        // Arrange
      ...
      test("when provided with a centre, and future funding submission lines exist but are not Quality Enhancement Program sections, does not apply enhancement", async () => {
        // Arrange
        vi.setSystemTime(new Date("2025-04-01"))
      ...
      test("when multiple funding submission line JSON entries exist, applies enhancement to all Quality Enhancement Program sections across all entries", async () => {
        // Arrange
        vi.setSystemTime(new Date("2025-04-01"))
